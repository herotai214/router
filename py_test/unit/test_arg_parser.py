"""
Unit tests for argument parsing functionality in vllm_router.
...
class TestRouterArgs:
    ...
    def test_from_cli_args_basic(self):
        ...
        assert router_args.intra_node_data_parallel_size == 2
    ...
    def test_from_cli_args_pd_mode(self):
        ...
        args = SimpleNamespace(
            ...
            router_intra_node_data_parallel_size=1,
            router_api_key=None,
            router_log_dir=None,
