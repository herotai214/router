...
struct Router {
    ...
    max_tree_size: usize,
    cache_aware_load_metric: String,
        ...
        let convert_policy = |policy: &PolicyType| -> ConfigPolicyConfig {
            match policy {
                ...
                PolicyType::CacheAware => ConfigPolicyConfig::CacheAware {
                    ...
                    load_balance_metric: match self.cache_aware_load_metric.as_str() {
                        "token" => crate::config::CacheAwareLoadMetric::Token,
                        _ => crate::config::CacheAwareLoadMetric::Request,
                    },
...
impl Router {
    ...
    #[pyo3(signature = (
        ...
        cache_aware_load_metric = "request".to_string(),
