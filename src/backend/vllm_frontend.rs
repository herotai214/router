...
use vllm_chat::{
    load_model_backends, ChatContent, ChatMessage, ChatOptions, ChatRequest, GenerationPromptMode,
    LoadModelBackendsOptions, LoadedModelBackends,
};
...
pub fn chat_request_from_openai(
    request_id: String,
    ...
    request.add_special_tokens = add_special_tokens;
    request.chat_options = ChatOptions {
        generation_prompt_mode: if continue_final_message {
